...
CREATE TABLE `botiga` (
  ...
  `codi postal` tinytext DEFAULT NULL,
  `LOCALITAT_idLOCALITAT` int(11) NOT NULL,
  PRIMARY KEY (`idBOTIGA`),
  KEY `fk_BOTIGA_LOCALITAT1_idx` (`LOCALITAT_idLOCALITAT`),
  CONSTRAINT `fk_BOTIGA_LOCALITAT1` FOREIGN KEY (`LOCALITAT_idLOCALITAT`) REFERENCES `localitat` (`idLOCALITAT`) ON DELETE NO ACTION ON UPDATE NO ACTION
